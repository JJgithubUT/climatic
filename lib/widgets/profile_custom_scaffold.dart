...
class ProfileCustomScaffold extends StatefulWidget {
  const ProfileCustomScaffold({super.key, this.child});
  final Widget? child;

  @override
  State<ProfileCustomScaffold> createState() => _ProfileCustomScaffoldState();
}

class _ProfileCustomScaffoldState extends State<ProfileCustomScaffold>
